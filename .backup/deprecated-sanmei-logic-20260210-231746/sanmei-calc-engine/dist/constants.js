...
exports.SOLAR_TERMS = exports.YIN_YANG_MAP = exports.ELEMENT_MAP = exports.CONTROL_RELATIONS = exports.GENERATION_RELATIONS = exports.BUILD_LUCK_BRANCH = exports.WU_SHU_DUN = exports.WU_HU_DUN = exports.HIDDEN_STEMS = exports.KANSHI = exports.BRANCH_ELEMENTS = exports.BRANCH_YIN_YANG = exports.BRANCHES = exports.STEM_ELEMENTS = exports.STEM_YIN_YANG = exports.ELEMENTS = exports.STEMS = void 0;
exports.kanshiToString = kanshiToString;
exports.kanshiIndexToString = kanshiIndexToString;
exports.getSolarTermData = getSolarTermData;
// ============================================================================
...
// ============================================================================
exports.KANSHI = generateKanshi();
/**
 * 六十干支の生成
 * Rule: 陽干は陽支とペア、陰干は陰支とペアとなる
 * Formula: i番目 = stem[i % 10] + branch[i % 12]
 */
function generateKanshi() {
    const kanshi = [];
    for (let i = 0; i < 60; i++) {
        const stemIdx = i % 10;
        const branchIdx = i % 12;
        kanshi.push([exports.STEMS[stemIdx], exports.BRANCHES[branchIdx]]);
    }
    return kanshi;
}
/**
 * 干支の名前文字列を生成 (例: "甲子")
 */
function kanshiToString(stem, branch) {
    return `${stem}${branch}`;
}
/**
 * 干支インデックスから文字列を生成
 */
function kanshiIndexToString(index) {
    const [stem, branch] = exports.KANSHI[index];
 ...
 * テーブルにない年は近似値で推定
 */
function getSolarTermData(year) {
    const found = exports.SOLAR_TERMS.find((data) => data.year === year);
    if (found) {
        return found;
    }
    // テーブルにない年: 近似値を返す
