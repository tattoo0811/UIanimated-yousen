...
// 1991年3月7日 12:00生まれ（仮定）
const birthDate = new Date('1991-03-07T12:00:00');
const gender: 'male' = 'male';

console.log('=================================================');
console.log('九条巡（1991年3月7日生まれ）命式計算結果');
console.log('=================================================\n');
...
// 龍高星の有無
const hasRyukoko = Object.values(twelveStars).includes('龍高星');
console.log(`\n龍高星: ${hasRyukoko ? '✓ あり' : '✗ なし'}`);

// 総エネルギーチェック
console.log('\n--- 総エネルギーチェック ---');
console.log(`総エネルギー: ${result.energyScore}`);
...
// 物語の記述との照合
const checks = {
  '日柱: 乙亥': result.bazi.day.name === '乙亥',
  '天中殺: 申酉': dayBranchId === 3 || dayBranchId === 4, // 寅卯の日支→申酉天中殺
  '龍高星: あり': hasRyukoko,
  '総エネルギー: 15': result.energyScore === 15
};
...
console.log(`\n結論: ${allMatch ? '✓ すべて一致 - このままでOK' : '✗ 不一致あり - 代替案が必要'}`);
