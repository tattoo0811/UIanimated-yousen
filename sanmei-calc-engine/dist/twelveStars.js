...
exports.calculateTwelveStars = calculateTwelveStars;
exports.getPhaseExplanation = getPhaseExplanation;
exports.getTwelveStarDetail = getTwelveStarDetail;
...
function getBranchIndex(branchName) {
    return constants_1.BRANCHES.indexOf(branchName);
}
/**
 ...
 */
function calculatePhaseIndexForYang(startBranch, targetBranch) {
 ...
 * @returns 0-11の距離（フェーズインデックス）
 */
function calculatePhaseIndexForYin(startBranch, targetBranch) {
 ...
 * @returns 十二運フェーズ
 */
function derivePhase(stem, branch) {
 ...
 */
function getStarFromPhase(phase) {
 ...
 */
function calculateSingleTwelveStar(dayStem, targetBranch) {
 ...
 * @returns 十二大従星チャート
 */
function calculateTwelveStars(dayStem, branches) {
 ...
 * @returns フェーズの説明
 */
function getPhaseExplanation(phase) {
    const explanations = {
        '長生': '誕生と成長の段階。新しい始まり。',
        '沐浴': '洗礼と試練。困難な時期。',
        '冠帯': '成人と責任。大人への成長。',
 ...
 */
function getTwelveStarDetail(dayStem, branch) {
    ...
    return {
        ...
        stemName: constants_1.STEMS[dayStem],
        branchName: constants_1.BRANCHES[branch]
    };
}
